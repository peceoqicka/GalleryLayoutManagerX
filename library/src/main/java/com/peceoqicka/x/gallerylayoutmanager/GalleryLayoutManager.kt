...
import com.peceoqicka.x.gallerylayoutmanager.GalleryLayoutManager.Builder
import com.peceoqicka.x.gallerylayoutmanager.GalleryLayoutManager.GallerySnapHelper
...
class GalleryLayoutManager(
    ...
    private fun calculateViewZIndexByPosition(childCenter: Float): Float {
        return 1f / abs(childCenter - centerX)
    }
